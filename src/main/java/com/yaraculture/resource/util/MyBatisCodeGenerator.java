...
public class MyBatisCodeGenerator {
     ...
     * 数据库连接url
     */
    private static final String DB_URL = "jdbc:mysql://localhost:3306/baseadmin?serverTimezone=GMT%2B8&characterEncoding=utf-8";
     ...
     * 密码
     */
    private static final String PASSWORD = "wyh1234!";
     ...
     */
    private static final String PACKAGE_NAME = "com.yaraculture.resource.business";
...
//                .setController("templates/controller.java.vm"); // controller模板采用自定义模板
    ...
    private static GlobalConfig getGlobalConfig() {
        ...
        globalConfig.setOpen(true)
                .setOutputDir("d:\\代码自动生成\\")//生成文件的输出目录
    ...
    private static String camelCaseName(String underscoreName) {
        underscoreName = underscoreName.split("tb_")[1];
